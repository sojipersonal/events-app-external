  ...
  it('responds with home page', function (done) {
    ...
    nock("http://localhost:8082")
      ...
      .reply(200, {
        "status": 200,
        "events": [
            { title: 'Book Club', id: 1234, description: 'kids love it', location: 'Pflugerville Library', likes: 0 },
            { title: 'Pizza Party', id: 5678, description: 'Wow......!!!!', location: 'Johns pizza', likes: 0 },
        ]
      });
